...
def multiply_quaternions(quaternion1, quaternion2):
    return np.array([-quaternion1[0] * quaternion2[0] - quaternion1[1] * quaternion2[1] - quaternion1[2] * quaternion2[2] + quaternion1[3] * quaternion2[3],
                     quaternion1[0] * quaternion2[3] + quaternion1[1] * quaternion2[2] - quaternion1[2] * quaternion2[1] + quaternion1[3] * quaternion2[0],
                     -quaternion1[0] * quaternion2[2] + quaternion1[1] * quaternion2[3] + quaternion1[2] * quaternion2[0] + quaternion1[3] * quaternion2[1],
                     quaternion1[0] * quaternion2[1] - quaternion1[1] * quaternion2[0] + quaternion1[2] * quaternion2[3] + quaternion1[3] * quaternion2[2]], dtype=np.float64)
...
def rotate_around_axis(axis_angle, axis, angle):
	quaternion1 = axis_angle_to_quaternion(axis_angle)
	axis_angle2 = angle * normalize(axis)
	quaternion2 = axis_angle_to_quaternion(axis_angle2)
